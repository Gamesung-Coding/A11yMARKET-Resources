## 겜성 코딩 - Document & Resource Repository

이 레포지토지는 개발팀의 문서(e.g., Proposal, WBS, Journal/Report), 기타 자료 및 자료 링크를 정리하고, 이를 쉽게 탐색할 수 있도록 하기 위한 저장소입니다.
...
- **문서/다이어그램:** [Outline-문서-HUB](https://docs.bluenyang.kr/s/gamesung-coding-document)
